...
statsd = TCPStatsClient(host=os.environ.get('STATSD_HOST', '127.0.0.1'), 
...
def init_influxdb_():
    influxdb_url = os.environ.get('INFLUXDB_HOST', 'http://127.0.0.1:8086')
...
def init_grafana_dashboard():
   ...
   if 'logged in' == data['message'].lower():
       ...
       payload = {"access": "direct", 
                   ...
                   "password": "root",
                   "type": "influxdb_08",
                   "url": os.environ.get('INFLUXDB_HOST', "http://127.0.0.1:8086"),
                   "user": "root"
                 } 
